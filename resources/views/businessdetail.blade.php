...
<body>
  ...
  <div class="slider-container">
    ...
    <a href="{{route('seemorebusinessdetail')}}" class="photos-link">See all 154 photos</a>
  </div>

    <!-- Top bar with action buttons -->
    <div class="top-bar">
        <div class="logo">Mountain Mike's Pizza</div>
        <div class="action-buttons">
          <button><i class="fa-solid fa-star"></i> Write a review</button>
          <button><i class="fa-solid fa-camera"></i> Add photo</button>
...
<div class="section-title" style="font-size: 18px; margin-bottom: 10px;">Popular Dishes</div>
      ...
      <div class="vibe-section">
        ...
        <div class="vibe-tags">
          <div class="vibe-tag">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 2a10 10 0 100 20 10 10 0 000-20zm0 2a8 8 0 018 8 8 8 0 11-16 0 8 8 0 018-8zm0 3a2 2 0 100 4 2 2 0 000-4zm0 6c-2.21 0-4 1.79-4 4h2a2 2 0 014 0h2c0-2.21-1.79-4-4-4z"/></svg>
            Good for groups
          </div>
          <div class="vibe-tag">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M2 6h20v2H2V6zm0 5h20v2H2v-2zm0 5h20v2H2v-2z"/></svg>
            Dogs allowed
          </div>
        </div>
      </div>
<br>
      ...
      <div class="location-hours">
        ...
        <div class="map-hours-container">
          <div class="map">
            ...
            <a
              href="https://www.google.com/maps/dir/?api=1&destination=35+Skyline+Plaza,+Daly+City,+CA+94015"
              target="_blank"
              rel="noopener noreferrer"
              title="Get directions to 35 Skyline Plaza"
            >
              <img
                src="D:\yelp website\rest\GoogleMapTA.webp"
                alt="Map of 35 Skyline Plaza"
              />
            </a>
            <div class="address">
              <a href="https://www.google.com/maps?q=35+Skyline+Plaza,+Daly+City,+CA+94015" target="_blank" rel="noopener noreferrer">
                35 Skyline Plaza
              </a><br />
              Daly City, CA 94015<br />
              <button onclick="window.open('//www.google.com/maps/dir/?api=1&destination=35+Skyline+Plaza,+Daly+City,+CA+94015', '_blank')">Get directions</button>
            </div>
          </div>
      ...
      <section class="recommendation-section" aria-label="Sponsored Recommendations">
        ...
        <article class="recommendation" role="article" aria-labelledby="rec1-title">
          <img src="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&w=80&q=80" alt="IHOP pancakes" class="rec-image" />
          <div class="rec-content">
            ...
            <p class="rec-review"><span class="reviewer">Jake C. said</span> <span class="quote-text">"my wife and i went here the other day for some breakfast. at first things were going fine ordered my food then my job called me in(i am an on call driver for a local auto dealership). they said it was a short local run so i figured..."</span><span class="read-more" tabindex="0">read more</span></p>
        ...
        <article class="recommendation" role="article" aria-labelledby="rec2-title">
          <img src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=80&q=80" alt="Dish from Lers Ros" class="rec-image" />
          <div class="rec-content">
            ...
            <p class="rec-review"><span class="reviewer">Manny F. said</span> <span class="quote-text">"I've been a few times now and a very embarrassing thing happened to me. We just finished paying and I went up the stairs to use the bathroom. The mens room was full and I really needed to go so I used the womens room. Not only did I..."</span><span class="read-more" tabindex="0">read more</span></p>
