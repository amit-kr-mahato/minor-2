        ...
        <div class="row">
            <div class="col-md-6 me-5">
                ...
                <p class="text-muted">
                    ...
                    search results until this information has been verified and approved by our moderators.
                ...
                <form action="{{ route('business.business_store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="businessName" class="form-label">Business Name <span class="required-star">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="city" name="city"
                                placeholder="Eg: Kathmandu, Pokhara, Lalitpur">
                            <div class="error" id="error-city"></div>
                        </div>

                        <div class="col-md-6 mb-3">
                            <label for="postalCode" class="form-label">Postal Code <span class="required-star">*</span></label>
                            <input type="text" class="form-control" id="postalCode" name="postal_code" placeholder="Eg: 47500">
                    ...
                    <div class="mb-3">
                        <label for="email" class="form-label fs-2">Your Email Address <span class="required-star">*</span></label>
                    ...
                    <div class="mb-3">
                        <p>By continuing, you agree to Bizlisto's <span class="text-primary">Business Terms</span> and
                            acknowledge our <span class="text-primary">Privacy Policy</span>. We may email you about
                            Bizlisto products, services, and local events. You can unsubscribe at any time.
                        </p>
                    </div>
...
<!-- JS for dynamic category fields -->
<script>
    function addCategory(event) {
        event.preventDefault();
        const container = document.getElementById('category-container');
        const group = document.createElement('div');
        group.classList.add('d-flex', 'align-items-center', 'mb-2', 'category-group');
        group.innerHTML = `
            <input list="categoryOptions" name="categories[]" class="form-control me-2"
                   placeholder="Select or type category" required>
            <a href="#" class="text-danger remove-category"
