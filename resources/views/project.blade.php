        ...
        <section class="container mt-4">
            ...
            <div class="row text-center mt-5">
                <div class="col-md-1 fs-4">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                    ...
                                    <form class="needs-validation" novalidate>
                                        <div class="col-md-10 mb-5">
                                            ...
                                            <input type="text" class="form-control" id="validationCustom05"
                                                placeholder="Zip code or location" required>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button class="btn btn-danger" data-bs-target="#exampleModalToggle3"
                                        data-bs-toggle="modal">Next</button>
                                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button class="btn btn-primary" data-bs-target="#exampleModalToggle2"
                                        data-bs-toggle="modal">Back</button>
                                    <button class="btn btn-danger" data-bs-target="#exampleModalToggle4"
                                        data-bs-toggle="modal">Next</button>
                                </div>
                    ...
                    <div class="modal fade" id="exampleModalToggle4" aria-hidden="true"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5">Do you Need items Moves up or down floor at your current
                                        location?<br>
                                ...
                                <div class="modal-footer">
                                    <button class="btn btn-primary" data-bs-target="#exampleModalToggle3"
                                        data-bs-toggle="modal">Back</button>
                                    <button class="btn btn-danger" data-bs-target="#exampleModalToggle5"
                                        data-bs-toggle="modal">Next</button>
                                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="radio-group">
                                        <form>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" name="move_size"
                                                    id="few_items">
                                ...
                                <div class="modal-footer">
                                    <button class="btn btn-primary" data-bs-target="#exampleModalToggle4"
                                        data-bs-toggle="modal">Back</button>
                                    <button class="btn btn-danger" data-bs-target="#exampleModalToggle6"
                                        data-bs-toggle="modal">Next</button>
                                </div>
                ...
                <div class="col-md-2 fs-4">
                    ...
                    <div class="modal fade" id="exampleModalToggle1" aria-hidden="true"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="radio-group">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="location"
                                                id="international">
                                            <label class="form-check-label" for="international">Move in or move-out
                                                cleaning</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="location"
                                ...
                                <div class="modal-footer">
                                    <button class="btn btn-primary" disabled>Back</button>
                                    <button class="btn btn-danger" data-bs-target="#exampleModalToggle11"
                                        data-bs-toggle="modal">Next</button>
                    ...
                    <div class="modal fade" id="exampleModalToggle11" aria-hidden="true"
                        aria-labelledby="exampleModalToggleLabel11" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-footer">
                                    <button class="btn btn-primary" data-bs-target="#exampleModalToggle11"
                                        data-bs-toggle="modal">Back</button>
                                    <button class="btn btn-danger" data-bs-target="#exampleModalToggle13"
                                        data-bs-toggle="modal">Next</button>
                                </div>
                    ...
                    <div class="modal fade" id="exampleModalToggle13" aria-hidden="true"
                        aria-labelledby="exampleModalToggleLabel13" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-footer">
                                    <button class="btn btn-primary" data-bs-target="#exampleModalToggle11"
                                        data-bs-toggle="modal">Back</button>
                                    <button class="btn btn-danger" data-bs-target="#exampleModalToggle14"
                                        data-bs-toggle="modal">Next</button>
                                </div>
                    ...
                    <div class="modal fade" id="exampleModalToggle14" aria-hidden="true"
                        aria-labelledby="exampleModalToggleLabel14" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-footer">
                                    <button class="btn btn-primary" data-bs-target="#exampleModalToggle13"
                                        data-bs-toggle="modal">Back</button>
                                    <button class="btn btn-danger" data-bs-target="#exampleModalToggle15"
                                        data-bs-toggle="modal">Next</button>
                                </div>
                    ...
                    <div class="modal fade" id="exampleModalToggle15" aria-hidden="true"
                        aria-labelledby="exampleModalToggleLabel15" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-footer">
                                    <button class="btn btn-primary" data-bs-target="#exampleModalToggle14"
                                        data-bs-toggle="modal">Back</button>
                                    <button class="btn btn-danger" data-bs-target="#exampleModalToggle16"
                                        data-bs-toggle="modal">Next</button>
                                </div>
                    ...
                    <div class="modal fade" id="exampleModalToggle16" aria-hidden="true"
                        aria-labelledby="exampleModalToggleLabel16" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-footer">
                                    <button class="btn btn-primary" data-bs-target="#exampleModalToggle15"
                                        data-bs-toggle="modal">Back</button>
                                    <button class="btn btn-danger" data-bs-target="#exampleModalToggle16"
                                        data-bs-toggle="modal">Next</button>
                                </div>
